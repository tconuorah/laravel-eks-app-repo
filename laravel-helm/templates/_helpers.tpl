...
*/}}
{{- define "laravel.nginxConfigMapName" -}}
{{- printf "%s-nginx" (include "laravel.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create the name of the secret containing Laravel environment values.
*/}}
...
{{- .Values.secret.name }}
{{- else }}
{{- printf "%s-env" (include "laravel.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
